...
import com.game.Model.ItemsEmitter;
import com.game.Model.TextEmitter;
import com.game.View.Map;
import com.game.View.characters.GameCharacter;
import com.game.View.characters.Hero;
import com.game.View.characters.Monster;
...
//    private Sound sound;
    ...
    public com.game.View.Map getMap() {
        return map;
    }
...
//        sound.play();
    ...
    public void update(float dt) {
        if (!paused) {
            ...
            for (int i = 0; i < itemsEmitter.getItems().length; i++) {// обход коллекций
